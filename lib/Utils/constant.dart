...
final String appName = 'The Gold Gallery';
bool notificationStatus = true;
int notificationId = 1;
final String packageName = 'com.thegoldgallery.user';
const String languageCode = 'languageCode';
final String baseUrl = "https://developmentalphawizz.com/gold_gallery/app/v1/api/";
