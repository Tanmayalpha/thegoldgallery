...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff0C1723);
  static const Color secondary = Color(0xffFFE972);
  ...
  static const Color grad2Color = Color(0xffFFE972);
  static const Color lightWhite2 = Color(0xffEEF2F3);
  static const Color primary2 = Color(0xff0C1723);
  static const Color secondary2 = Color(0xffF1D459);
